...
//        AddEvent(gameObject, EventTriggerType.PointerExit, delegate { OnEnterInterface(gameObject); });
//    }
...
//                Debug.Log(inventory.database.GetItem[slot.Value.item.Id].uiDisplay.name);
...
//    public void OnExitInteface(GameObject obj) {
...
//            Debug.Log("XDDDDDDDDDDDDDDDDDDDDDDD");
